# -*- coding: utf-8 -*-
"""
Created on Thu Jan 12 21:24:35 2023
...
def feature_engineering(df):
    ...
    # categorize apps
    bins = joblib.load('encoders/bins_apps.joblib')
    df['apps_cat'] = pd.cut(df["apps"], bins=bins, labels=False, include_lowest=True)
